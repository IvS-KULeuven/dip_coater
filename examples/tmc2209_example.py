#!/usr/bin/env python3
"""TMC2209 example for the small dip-coater setup.

What this script shows:
- how to select the TMC2209 driver
- how to select the small setup profile
...
The TMC2209 driver uses Raspberry Pi GPIO pins. On macOS, Windows, or an
unknown board this driver falls back to the mock implementation.
"""
...
DRIVER = AvailableMotorDrivers.TMC2209
SETUP = AvailableMachineSetups.SMALL_COATER


def build_controller(*, use_dummy_driver: bool) -> MotionController:
    """Create a motion controller for the TMC2209 small-coater setup."""
...
async def main_async() -> None:
    ...
    args = parse_args()
    controller = build_controller(use_dummy_driver=not args.real_hardware)
    try:
