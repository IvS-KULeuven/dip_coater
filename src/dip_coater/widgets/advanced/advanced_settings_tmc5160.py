...
from dip_coater.motor_driver.tmc5160.tmc5160 import ChopperMode
...
class AdvancedSettingsTMC5160(AdvancedSettingsBase):
    ...
    def __init__(self, app_state):
        ...
        default_chopper = ChopperMode.from_label(self.app_state.config.DEFAULT_CHOPPER_MODE)
        self.update_chopper_mode(default_chopper)
    ...
    def additional_widgets(self) -> ComposeResult:
        with Horizontal(id="interpolation-container"):
            ...
            yield Select(
                ...
                value=ChopperMode.from_label(
                    self.app_state.config.DEFAULT_CHOPPER_MODE
                ).label,
                allow_blank=False,
                classes="select",
            )
    ...
    def reset_settings_to_default(self):
        ...
        default_chopper_mode = ChopperMode.from_label(
            self.app_state.config.DEFAULT_CHOPPER_MODE
        )
